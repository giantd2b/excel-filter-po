      ...
      <div className="px-3 py-2 border-b border-slate-50">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-7 pr-2 py-1.5 text-[12px] bg-slate-50 rounded-lg border-0 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:bg-white placeholder:text-slate-300 transition-all"
            autoFocus
          />
        </div>
      </div>
            ...
            <div key={category}>
              ...
              {items.map((t) => (
                <button
                  ...
                  className="w-full text-left px-3.5 py-2.5 hover:bg-indigo-50/60 transition-all duration-150 border-b border-slate-50 last:border-0"
                >
